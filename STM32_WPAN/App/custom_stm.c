...
#include "../../Core/Add/Ble_control/Inc/ble_control.h"
...
tBleStatus Custom_STM_App_Update_Char_Ext(uint16_t Connection_Handle, Custom_STM_Char_Opcode_t CharOpcode, uint8_t *pPayload)
{
  ...
  switch (CharOpcode)
  {
    ...
    case CUSTOM_STM_MY_CHAR:
	  ...
	  Generic_STM_App_Update_Char_Ext(Connection_Handle, CustomContext.CustomMy_Custom_SvcHdle, CustomContext.CustomMy_CharHdle, SizeMy_Char, pPayload);
